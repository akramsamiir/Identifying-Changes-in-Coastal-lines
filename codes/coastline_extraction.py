...
main_path = r'C:\Users\Muhammed\Documents\Graduation Project\Caspian'
...
for fname in tqdm(fnames):
    ...
    with rasterio.open(f'{main_path}/caspian sea outputs/cleaned_segmentation/{fname}-segmentation.tif', 'w', **profile) as dst:
            dst.write((segmentation * 255).astype(rasterio.uint8), 1)
            
    with rasterio.open(f'{main_path}/caspian sea outputs/coastline_raster/{fname}-edge.tif', 'w', **profile) as dst:
